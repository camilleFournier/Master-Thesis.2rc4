...
%\todo[inline]{I think this is redundant since you are listing them above}
...
\subsection{Academic Research} \todo[inline, color=orange!40]{Related work?}
...
\todo[inline, color=orange!40]{This seems like a methodology to me.}
...
\subsection{Android}
\todo[inline, color=orange!40]{Android}
...
\subsection{Chrome}
\todo[inline, color=orange!40]{PWA}
...
\todo[inline, color=orange!40]{Every chapter should have a conclusion and an introduction to the next chapter. No more than 5 sentences. Overall conclusion about the chapter, for example}
