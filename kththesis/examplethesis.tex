...
\todo[inline, color=cyan!20]{Should I move this paragraph to scripts implementation ?}
...
\todo[inline, color=cyan!20]{I should probably finish all the scripts before doing this last part since some technical aspects can change}
